...
const citiesList = new mongoose.Schema(
...
const Cities = mongoose.model('cities', citiesList)
/*
...
/* MOYENNE DE POPULATION
  ...
  Cities
   ...
   .group(
       {
           _id: "$department",
           populationMoyenne: { $avg: "$population" },
       }
   )
   .sort({population:-1})
   .then((response) => console.log(response));*/
...
/*NOMBRE DE VILLE PAR DEPARTEMENT
